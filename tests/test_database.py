...
def test_add_update_records(mocker):
    ...
    existing_data = [
        MockTable(id=1, name="Test1"),
        MockTable(id=2, name="Test2"),
        MockTable(id=3, name="Test3"),
        MockTable(id=4, name="Test4"),
    ]
    ...
    new_data = pd.DataFrame(
        columns=["id", "name"],
        data=[[1, "Banana"], [2, "Test2"], [5, "angel"], [6, "fallen"]],
    )
    add_and_update_records(mock_engine, MockTable, "id", new_data)
    expected_result = [
        MockTable(id=1, name="Banana"),
        MockTable(id=2, name="Test2"),
        MockTable(id=3, name="Test3"),
        MockTable(id=4, name="Test4"),
        MockTable(id=5, name="angel"),
        MockTable(id=6, name="fallen"),
    ]
